...
const datePicker = flatpickr("#date-picker", {
    ...
    onChange: async function(selectedDates, dateStr) {
        ...
        try {
            ...
            const response = await fetch(`https://us-central1-laurensalon-cc2da.cloudfunctions.net/getEvents?date=${dateStr}`);
...
async function submitBooking() {
  ...
  try {
    const response = await fetch('https://us-central1-laurensalon-cc2da.cloudfunctions.net/addEvent', {
      method: 'POST',
      headers: {
        ...
        if (validateForm()) {
            ...
            async function updateCalendarEvent() {
                try {
                    ...
                    const response = await fetch('https://us-central1-laurensalon-cc2da.cloudfunctions.net/updateEvent', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                        },
    ...
    document.getElementById('custom-cancel-yes').onclick = function() {
        ...
        async function deleteCalendarEvent() {
            ...
            try {
                ...
                const response = await fetch('https://us-central1-laurensalon-cc2da.cloudfunctions.net/deleteEvent', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
